...
############### Create ###############
//Das Challangeboard
$challange_board = database::query("
...
#################  Fill config  ###################################################################
###################################################################################################
$password = '$'.'6'.'$'.'rounds=7000'.'$'.'stadtwerke_secur'.'$'.'FiMtE/YWpN17eeywkci55HJSarkUOlnbpOJ4KWp7V.IowoqaR/ymrnbWNEAuZkNX0q3polm8hnzX8aXZmKavI1';
//Create Default admin user -> Default Password
$sql = "INSERT INTO `users` (`id`,`username`,`password`,`group`,`punkte`) VALUES (1, 'admin', '" . $password . "', 'admin', 100)";
database::query($sql);
...
//Erstelle backup in cb_backup Tabelle vom Challangeboard
 ...
 //Fallback
 if ($_SERVER["REQUEST_URI"] !=	WS_DIR_HTTP_HOME) {
	echo '<script>window.location.href = "' . WS_DIR_HTTP_HOME . '";</script>';
 }
 exit;
